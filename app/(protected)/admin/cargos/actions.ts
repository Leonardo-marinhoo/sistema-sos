...
export async function createJob(formData: FormData) {
  ...
  }, { action: "create", entityType: "job", description: "Criação de cargo" });
}
...
export async function updateJob(formData: FormData) {
  return withLogging(async () => {
    ...
    if (error) throw new Error(error.message);
    revalidatePath("/admin/cargos");
  }, { action: "update", entityType: "job", description: "Atualização de cargo" });
}
...
export async function deleteJob(formData: FormData) {
  return withLogging(async () => {
    ...
    if (error) throw new Error(error.message);
    revalidatePath("/admin/cargos");
  }, { action: "delete", entityType: "job", description: "Exclusão de cargo" });
}
...
export async function saveJobKitItem(formData: FormData) {
  return withLogging(async () => {
    ...
    revalidatePath("/admin/cargos");
  }, { action: "create", entityType: "job", description: "Atualização do kit do cargo" });
}
