...
export async function createUser(formData: FormData) {
  return withLogging(
    ...
    { action: "create", entityType: "user", description: "Criação de usuário" }
  );
}
...
export async function updateUser(formData: FormData) {
  return withLogging(
    ...
    { action: "update", entityType: "user", description: "Atualização de usuário" }
  );
}
...
export async function deleteUser(formData: FormData) {
  return withLogging(
    ...
    { action: "delete", entityType: "user", description: "Exclusão de usuário" }
  );
}
